...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    private Node<E> createLevelOrderHelper(ArrayList<E> l, Node<E> p, int i) {
        /*if (i < l.size()) {
            Node<E> newest = createNode(l.get(i), p, p.getLeft(), p.getRight());
            newest.setLeft(createLevelOrder(l, newest.getLeft(), 2 * i + 1));
            newest.setRight(createLevelOrder(l, newest.getRight(), 2 * i + 2));
            size++;
            return newest;
        } else {
            return p;
    ...
    private Node<E> createLevelOrderHelper(E[] arr, Node<E> p, int i) {
        /*if (i < arr.length) {
            Node<E> newest = createNode(arr[i], p, p.getLeft(), p.getRight());
